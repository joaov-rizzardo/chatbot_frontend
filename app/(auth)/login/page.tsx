...
import { ArrowRight, Eye, Lock, Mail, MessageSquare } from "lucide-react";

export default function Login() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-sidebar-primary via-sidebar-accent to-emerald-950 flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <Card className="bg-sidebar-primary/80 backdrop-blur-xl border-white/10 shadow-2xl">
